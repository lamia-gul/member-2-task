...
import { editHabit } from '../../store/habitSlice'; // 👈 Importing our new edit action
...
export default function EditHabitScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Prune Your Habit ✂️🌿</Text>
      ...
      <View style={styles.row}>
        {['Daily', 'Weekly'].map((freq) => (
          ...
          >
            <Text style={[styles.chipText, frequency === freq && styles.chipTextActive]}>{freq}</Text>
          </TouchableOpacity>
        ))}
      </View>

      <Text style={styles.label}>Choose your Plant Species</Text>
      <View style={styles.row}>
